	...
	<div class="md:flex md:gap-12">
		...
		<div class="md:basis-7/12 md:shrink-0 md:grow-0">
			...
			<div class="my-6">
				...
				<p>This course is free and self-timed. You only need to register before starting the course in order to gain access to course materials and related assets.</p>
				...
				?>
					...
					<section class="my-6 bg-gray-600 p-4 text-white rounded-lg">
						<h2 class="text-lg font-semibold">Registration Details</h2>
						<ul>
							<li>Registration Status: Active</li>
							<li>Registration Date: <?php echo $userData->registration_date; ?></li>
						</ul>
					</section>
